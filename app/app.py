...
fastapi_url = os.getenv('FASTAPI_URL', 'http://localhost:8000')  # Use the Docker service name
...
if __name__ == "__main__":
    main()
    # subprocess.call(["streamlit", "run", "app/app.py", "--server.port", "8501", "--server.address", "0.0.0.0"])
